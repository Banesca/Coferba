...
class Product_model extends CI_Model
{
	...
	public function addinternet($item) {
			...
			$this->db->insert('tb_client_services_internet', array(
	...
	public function addgps($item) {
		...
		$this->db->insert('tb_client_services_gps', array(
			'idClientServicesFk' => $idClientServicesFk,
	...
	public function addaccescontrol($item) {
		...
		$this->db->insert('tb_client_services_acces_control', array(
			'idClientServicesFk' => $idClientServicesFk,
			'door'  => $item['door'],
			'contract'  => $item['contract'],
			'dateUp'  => $item['dateUp'],
	...
	public function addsmartpanic($item) {
		...
		$this->db->insert('tb_client_services_smart_panic', array(
			'idClientServicesFk' => $idClientServicesFk,
	...
	public function addcamera($item) {
		...
		$this->db->insert('tb_client_services_camera', array(
			'name' => $item['name'],
			'contract' => $item['contract'],
			'idTypeMaintenanceFk' => $item['idTypeMaintenanceFk'],
			'dateUp' => $item['dateUp'],
	...
	public function addTotem($item) {
		...
		$this->db->insert('tb_client_services_totem', array(
			'name' => $item['name'],
	...
	public function insertService($product){
		$this->db->insert('tb_client_services', array(
