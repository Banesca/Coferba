...
/*Table structure for table `tb_batery_install_alarm` */

DROP TABLE IF EXISTS `tb_batery_install_alarm`;

CREATE TABLE `tb_batery_install_alarm` (
  `idBateryInstallAlarm` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idBateryInstallAlarm`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `tb_batery_install_alarm` */
...
CREATE TABLE `tb_client_services_access_control` (
  ...
  `nroSerieInternal` int(20) DEFAULT NULL,
  `nroSerieManufacturer` int(20) DEFAULT NULL,
